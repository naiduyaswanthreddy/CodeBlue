...
app.use(express.static(path.join(__dirname, '..','CodeBlue','Front End', 'src', 'HTML')));
app.use(express.static(path.join(__dirname, '..', 'CodeBlue','Front End', 'src', 'CSS')));
app.use(express.static(path.join(__dirname, '..', 'CodeBlue','Front End', 'src', 'img')));
app.use(express.static(path.join(__dirname, '..', 'CodeBlue','Front End', 'src', 'js')));
